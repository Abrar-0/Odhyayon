...
public final class ActivityTeacherloginBinding implements ViewBinding {
  ...
  private ActivityTeacherloginBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull EditText editTextTextPassword, @NonNull EditText email,
  ...
  public static ActivityTeacherloginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_teacherlogin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityTeacherloginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTeacherloginBinding((ConstraintLayout) rootView, button,
          editTextTextPassword, email, imageView4, progressBar, textView, textView6, textView7,
          textView8);
    }
